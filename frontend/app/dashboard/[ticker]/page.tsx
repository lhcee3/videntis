    ...
    <div className="min-h-screen">
      <header className="sticky top-0 bg-bg/95 backdrop-blur-sm border-b border-border p-6 flex justify-between items-center z-10">
        ...
        <div className="flex items-center gap-6">
          <Link href="/portfolio" className="font-mono text-xs text-[#9ca3af] hover:text-[#f0ede8] uppercase tracking-widest transition-colors relative after:absolute after:bottom-0 after:left-0 after:h-px after:w-0 after:bg-[#f0ede8] after:transition-all hover:after:w-full">
            Portfolio
          </Link>
          <Link href="/watchlist" className="font-mono text-xs text-[#9ca3af] hover:text-[#f0ede8] uppercase tracking-widest transition-colors relative after:absolute after:bottom-0 after:left-0 after:h-px after:w-0 after:bg-[#f0ede8] after:transition-all hover:after:w-full">
            Watchlist
          </Link>
