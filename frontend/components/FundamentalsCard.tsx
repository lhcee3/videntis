  ...
  return (
    <div className="border border-[#1e1e1e] p-6">
      <div className="flex items-center justify-between mb-6">
        <span className="font-mono text-[10px] text-[#9ca3af] uppercase tracking-[0.2em]">(03) FUNDAMENTALS</span>
        <div className="text-right">
          <div className="font-mono text-[10px] text-[#9ca3af]">FUNDAMENTAL SCORE</div>
      ...
      {f.description && (
        <p className="font-mono text-xs text-[#9ca3af] mb-4 leading-relaxed border-l-2 border-[#1e1e1e] pl-3">
          {f.description}
        </p>
      )}
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
        <div>
          <div className="font-mono text-[10px] text-[#9ca3af] mb-2">VALUATION</div>
        ...
        <div>
          <div className="font-mono text-[10px] text-[#9ca3af] mb-2">GROWTH & HEALTH</div>
