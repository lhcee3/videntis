  ...
  return (
    <div className="border border-[#1e1e1e] p-6">
      <div className="flex items-center justify-between mb-6">
        <span className="font-mono text-[10px] text-[#9b9895] uppercase tracking-[0.2em]">(02) TECHNICAL INDICATORS</span>
        <div className="text-right">
          <div className="font-mono text-[10px] text-[#9b9895]">TECHNICAL SCORE</div>
      ...
      <div className="grid grid-cols-2 md:grid-cols-4 gap-4 mb-6">
        <div className="border border-[#1e1e1e] p-4">
          <div className="font-mono text-[10px] text-[#9b9895] mb-1">RSI (14)</div>
        ...
        <div className="border border-[#1e1e1e] p-4">
          <div className="font-mono text-[10px] text-[#9b9895] mb-1">MACD</div>
        ...
        <div className="border border-[#1e1e1e] p-4">
          <div className="font-mono text-[10px] text-[#9b9895] mb-1">TREND</div>
          <div className="font-mono text-sm mt-2" style={{ color: trendColor }}>{t.trend}</div>
        </div>
        <div className="border border-[#1e1e1e] p-4">
          <div className="font-mono text-[10px] text-[#9b9895] mb-1">VOLUME</div>
          <div className="font-display text-2xl">{t.volume_ratio}x</div>
          <div className="font-mono text-[10px] text-[#9b9895] mt-1">vs 20-day avg</div>
        </div>
      </div>

      <div className="grid grid-cols-1 md:grid-cols-2 gap-4 mb-4">
        <div>
          <div className="font-mono text-[10px] text-[#9b9895] mb-3">MOVING AVERAGES</div>
        ...
        <div>
          <div className="font-mono text-[10px] text-[#9b9895] mb-3">BOLLINGER BANDS</div>
          {[["Upper", t.bb_upper, "#ff4444"], ["Mid", t.bb_mid, "#9b9895"], ["Lower", t.bb_lower, "#00ff87"]].map(([label, val, color]) => (
            <div key={label as string} className="flex justify-between items-center py-1.5 border-b border-[#1e1e1e]">
              <span className="font-mono text-xs text-[#9b9895]">{label}</span>
          ...
          <div className="flex justify-between items-center py-1.5 border-b border-[#1e1e1e]">
            <span className="font-mono text-xs text-[#9b9895]">Support</span>
            <span className="font-mono text-xs text-[#00ff87]">${t.support}</span>
          </div>
          <div className="flex justify-between items-center py-1.5">
            <span className="font-mono text-xs text-[#9b9895]">Resistance</span>
